...
<!-- Mirrored from uxliner.com/ovio/demo/pages/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Sep 2017 06:48:30 GMT -->
<head>
<meta charset="utf-8">
...
<div class="wrapper">
  <div class="form-body">
    ...
    <div class="col-logo"><a href="index.jsp"><img alt="" src="../dist/img/logo-lg.png"></a></div>
      ...
      <footer class="text-right">
        <button type="button" class="btn btn-info pull-right">Register</button>
        <a href="login.jsp" class="button button-secondary">Login</a> </footer>
    </form>
  </div>
</div>
<!-- wrapper --> 

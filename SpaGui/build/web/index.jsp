...
<!-- Mirrored from uxliner.com/ovio/demo/pages/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Sep 2017 06:48:29 GMT -->
<head>
<meta charset="utf-8">
  ...
  <div class="form-body">
    ...
    <div class="col-logo"><a href="../index.html"><img alt="" src="../dist/img/logo-lg.png"></a></div>
      ...
      <fieldset>
        ...
        <section>
          <div class="row">
            <div class="col-md-6 checkbox"> <a href="forgot-password.jsp" class="modal-opener">Forgot password?</a> </div>
      ...
      <footer class="text-right">
        ...
        <a href="register.jsp" class="button button-secondary">Register</a> </footer>
    </form>
  </div>
</div>
<!-- wrapper --> 
...
<!-- Mirrored from uxliner.com/ovio/demo/pages/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Sep 2017 06:48:30 GMT -->
</html>
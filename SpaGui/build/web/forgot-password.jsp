...
<!-- Mirrored from uxliner.com/ovio/demo/pages/forgot-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Sep 2017 06:48:30 GMT -->
<head>
<meta charset="utf-8">
  ...
  <div class="form-body">
    ...
    <div class="col-logo"><a href="../index.html"><img alt="" src="../dist/img/logo-lg.png"></a></div>
      ...
      <fieldset>
        <section>
          <div class="form-group has-feedback">
            Enter your email address and your password will be reset and emailed to you.</div>
        </section>
        <section>
          <div class="form-group has-feedback">
      ...
      <footer class="text-right">
        <button type="button" class="btn btn-info pull-right">Send New Password</button>
        </footer>
    </form>
  </div>
</div>
